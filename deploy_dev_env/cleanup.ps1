################################################################################
# Complete Cleanup Script for Development Environment - v0.6.3 (PowerShell)
...
if (-not $SkipConfirmation) {
    ...
    Write-Host "[AUTO] Confirmation skipped - cleaning up existing environment..." -ForegroundColor Yellow
}
