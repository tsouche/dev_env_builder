...
# Rust Development Environment v0.6.2 - Auto-generated
Host rust-dev
    HostName localhost
    Port $($env:SSH_PORT)
    User $($env:USERNAME)
...
// Auto-generated by deploy-dev.ps1 v0.6.2
...
if (Test-Path $testScriptSource) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Warning-Custom "Failed to copy test script to container"
    }
} else {
    Write-Warning-Custom "Test script not found: $testScriptSource"
}
