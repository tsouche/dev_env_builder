################################################################################
# Development Environment Deployment Script - v0.6.10 (PowerShell)
...
# Rust Development Environment v0.6.10 - Auto-generated
Host rust-dev
    HostName localhost
    Port $($env:SSH_PORT)
    User $($env:USERNAME)
...
// Auto-generated by deploy-dev.ps1 v0.6.10
